...
export default {
  ...
  setup() {
    ...
    const fetchCustomers = async () => {
      try {
        const response = await fetch("http://localhost/project-67700660_vue/api_php/customer_crud.php");
    ...
    const saveCustomer = async () => {
      const url = "hhttp://localhost/project-67700660_vue/api_php/customer_crud.php";
    ...
    const deleteCustomer = async (id) => {
      ...
      try {
        const response = await fetch("http://localhost/project-67700660_vue/api_php/api_customer.php", {
          method: "DELETE",
          headers: { "Content-Type": "application/json" },
